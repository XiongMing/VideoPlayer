...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --enable-cross-compile --cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --as='/usr/bin/gas-preprocessornew.pl -as-type apple-clang -arch arm -add-prefix /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.2.sdk --enable-cross-compile --enable-nonfree --enable-gpl --enable-avutil --enable-swscale --enable-swresample --enable-avformat --enable-avcodec --disable-armv5te --disable-swscale-alpha --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-debug --disable-shared --disable-bzlib --disable-zlib --disable-iconv --enable-neon --enable-optimizations --enable-runtime-cpudetect --enable-memalign-hack --enable-small --enable-static --disable-shared --disable-vfp --extra-cflags='-arch armv7 -mios-version-min=5.0 -mthumb -mfloat-abi=softfp -march=armv7 -mfpu=neon -flax-vector-conversions' --extra-ldflags='-arch armv7 -mios-version-min=5.0' --prefix=ios/armv7 --arch=arm --cpu=cortex-a8
prefix=ios/armv7
...
CC_IDENT=Apple LLVM version 6.0 (clang-600.0.57) (based on LLVM 3.5svn)
ARCH=arm
INTRINSICS=neon
CC=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
CXX=g++
AS=/usr/bin/gas-preprocessornew.pl -as-type apple-clang -arch arm -add-prefix /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
LD=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
DEPCC=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/usr/bin/gas-preprocessornew.pl -as-type apple-clang -arch arm -add-prefix /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.2.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.2.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE
CFLAGS=  -arch armv7 -mios-version-min=5.0 -mthumb -mfloat-abi=softfp -march=armv7 -mfpu=neon -flax-vector-conversions -mcpu=cortex-a8 -std=c99 -mdynamic-no-pic -fomit-frame-pointer -mthumb -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch armv7 -mios-version-min=5.0 -mthumb -mfloat-abi=softfp -march=armv7 -mfpu=neon -flax-vector-conversions -mcpu=cortex-a8 -mdynamic-no-pic -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
DOXYGEN=doxygen
LDFLAGS= -arch armv7 -mios-version-min=5.0  --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.2.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.2.sdk -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
...
EXTRALIBS=-framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -lm -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavutil_VERSION=54.7.100
libavutil_VERSION_MAJOR=54
libavutil_VERSION_MINOR=7
libpostproc_VERSION=53.0.100
